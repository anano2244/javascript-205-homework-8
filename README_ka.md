...
სულ **ხუთი სავარჯიშოა** და ყველა მათგანში ციკლებს ამ მეთოდებით ჩაანაცვლებთ. დანარჩენი ყველაფერი ის არის, რაც უკვე იცით: ცვლადები, მასივები, ობიექტები, შაბლონური სტრიქონები (template literals) და ისრიანი ფუნქციები.
...
| | |
|---|---|
| **[📚 სავარჯიშოები](./EXERCISES_ka.md)** | ხუთი სავარჯიშო, მათი მოსალოდნელი შედეგი და წესები |
