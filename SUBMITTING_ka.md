...
გახსენით https://github.com/JavaScriptADI/javascript-205-homework-8 ბრაუზერში.
...
თუ უკვე აღარ ხართ თქვენს ფოლდერში, გამოტოვეთ `cd ../..` ხაზი — შეამოწმეთ `pwd`-ით, რომ `javascript-205-homework-8`-ში ხართ.
...
2. შეამოწმეთ გვერდის თავზე მოცემული ოთხი ჩამონათვალი:
   * **base repository:** `JavaScriptADI/javascript-205-homework-8` და **base:** `main`
   * **head repository:** `<your-username>/javascript-205-homework-8` და **compare:** `<your-username>`
3. **სათაური:** "Homework 8 - Your Name" თქვენი ნამდვილი სახელით, მაგალითად "Homework 8 - Nino Beridze".
...
> **კარგია, რომ იცოდეთ**
>
> * **თავდაპირველ** რეპოზიტორიაში (`JavaScriptADI/javascript-205-homework-8`) push ვერ გააკეთებთ და მისი `main` ბრენჩი დაცულია. ეს ასეც უნდა იყოს: თქვენი ნამუშევარი ყოველთვის თქვენს fork-ში, თქვენს ბრენჩზე მიდის და თავდაპირველ რეპოზიტორიას მხოლოდ Pull Request-ით სწვდება.
