...
Open https://github.com/JavaScriptADI/javascript-205-homework-8 in your browser.
...
```text
https://github.com/<your-username>/javascript-205-homework-8
```
...
```bash
git clone https://github.com/<your-username>/javascript-205-homework-8.git
cd javascript-205-homework-8
```
...
If you are not inside your folder any more, skip the `cd ../..` line — check with `pwd` that you are in `javascript-205-homework-8`.
...
2. Check the four dropdowns at the top of the page:
   * **base repository:** `JavaScriptADI/javascript-205-homework-8` and **base:** `main`
   * **head repository:** `<your-username>/javascript-205-homework-8` and **compare:** `<your-username>`
3. **Title:** "Homework 8 - Your Name" with your real name, for example "Homework 8 - Nino Beridze".
...
> **Good to know**
>
> * You cannot push to the **original** repository (`JavaScriptADI/javascript-205-homework-8`) and its `main` branch is protected. That is expected: your work always goes to your fork, on your branch, and reaches the original repository only through a Pull Request.
